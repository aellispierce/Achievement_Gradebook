...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   Achievement.create(name: "Set up Ruby", points: 100)
   Achievement.create(name: "Set up Rails", points: 200)
   Achievement.create(name: "Learn about control flow", points: 500)
   Achievement.create(name: "Learn about methods", points: 500)
   Achievement.create(name: "Learn about blocks", points: 800)
